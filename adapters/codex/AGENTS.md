...
This file contains a rolling log of the last 20 sessions across all AI tools (Claude Code, Codex, Gemini, Cursor). Use it for awareness — do NOT assume the user wants to continue their last task. Wait for direction.
